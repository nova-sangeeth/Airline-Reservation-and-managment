...
Public Class Form1
    ...
    Private Sub Button4_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If ComboBox1.Text = "USER" Then
            ...
            cnPodaci.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=G:\project files\Airline Reservation System VB.NET\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
            cnPodaci.Open()
        ...
        ElseIf ComboBox1.Text = "ADMIN" Then
            ...
            If TextBox10.Text = "Administrator" Or TextBox11.Text = "password" Then
                Beep()
                Beep()
